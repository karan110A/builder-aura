      ...
      <div className="w-full max-w-md relative z-20">
            ...
            <CardContent>
              ...
              <div className="mt-6">
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  <Button
                    variant="outline"
                    className="w-full bg-white/10 border-white/20 text-white hover:bg-white/20 transition-all duration-300 backdrop-blur-sm"
                  >
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-white/70">
            ...
            <Link
              to="/contact"
              className="text-white/90 hover:text-white transition-colors duration-300 underline"
            >
              Contact Support
            </Link>
          </p>
