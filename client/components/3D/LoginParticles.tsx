...
export default function LoginParticles({ count = 1000, mousePosition }: LoginParticlesProps) {
  ...
  useFrame((state) => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      positionAttribute.array[i3 + 1] += velocities[i3 + 1] + Math.sin(time + i * 0.01) * 0.001;
